...
2. **A sourcing figure is unverified.** A "100% Humboldt sourced" statistic appears in the
   internal review build carrying a confirmation flag. It has been **removed from this public
   copy** rather than published unverified.
...
- removes internal QA annotations that are meant for the agency, not for readers;
- removes the unverified sourcing statistic;
